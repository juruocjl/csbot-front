...
export const MajorHomeworkPersonalRowSchema = z.object({
  ...
  eventWinnerLogo: z.string().nullable().optional(),
  eventLoser: z.string().nullable().optional(),
  eventLoserLogo: z.string().nullable().optional(),
  eventScore: z.string().nullable().optional(),
...
export const SteamStatusItemSchema = z.object({
  ...
  party_id: z.string(),
  party_size: z.string(),
  rich_presence_string: z.string(),
  rich_presence: z.record(z.string(), z.string()),
  state: z.string()
})
